...
public class KafkaConfiguration {
    ...
    @Bean
	public NewTopic retry1000() {
		return TopicBuilder.name("Register.User.retry.1000")
				.partitions(1)
				.replicas(1)
				.build();
	}
	...
	@Bean
	public NewTopic retry3000() {
		return TopicBuilder.name("Register.User.retry.3000")
				.partitions(1)
				.replicas(1)
				.build();
	}
